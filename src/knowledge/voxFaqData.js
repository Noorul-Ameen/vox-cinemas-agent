  ...
  Object.freeze({
    ...
    utterances: Object.freeze({
      en: Object.freeze([
        ...
        "21 plus",
        "18tc",
        "what does the movie rating mean",
        "is the movie rating a review score",
        "will staff ask for id",
      ]),
      ar: Object.freeze([
        "التصنيف العمري",
        "شهادة تصنيف الفيلم",
        "هل يستطيع طفلي مشاهدة الفيلم",
        "دخول القاصرين",
        "تصنيف G",
        "تصنيف PG",
        "بي جي 13",
        ...
        "فوق 21",
        "تصنيف 18TC",
        "ما معنى تصنيف الفيلم",
        "هل تصنيف الفيلم درجة مراجعة",
        "هل يطلبون الهوية",
      ]),
    }),
    answer: Object.freeze({
      en: "VOX uses UAE age certificates, not review scores or star ratings. G means general exhibition and is open to all ages. PG means parental guidance is advised because some material may not be suitable for children. For PG13, guests aged 13 and under may attend only with someone aged 13 or older, and parents or guardians should decide whether the content is suitable. For PG15, guests aged 15 and under may attend only with someone aged 15 or older, and parents or guardians should decide whether the content is suitable. For 15+, nobody under 15 is admitted. For 18+, nobody under 18 is admitted. For 21+, nobody under 21 is admitted. For 15+, 18+ and 21+, infants and babies are not allowed, and identification and proof of age are required. Underage guests cannot enter restricted movies even with a parent. 18TC means the final certificate is pending approval and the film is provisionally treated as 18+; consider this before booking because tickets are non-refundable. For a particular movie, use the certificate shown in the current movie or showtime data.",
      ar: "تستخدم ڤوكس شهادات التصنيف العمري الإماراتية، وليست درجات تقييم نقدي أو نجوماً للمراجعة. يعني G عرضاً عاماً متاحاً لجميع الأعمار. ويعني PG أنه يوصى بإرشاد الوالدين لأن بعض المواد قد لا تناسب الأطفال. في PG13 يمكن للضيوف بعمر 13 سنة أو أقل الحضور فقط برفقة شخص عمره 13 سنة أو أكثر، ويقرر الوالدان أو ولي الأمر مدى ملاءمة المحتوى. وفي PG15 يمكن للضيوف بعمر 15 سنة أو أقل الحضور فقط برفقة شخص عمره 15 سنة أو أكثر، ويقرر الوالدان أو ولي الأمر مدى ملاءمة المحتوى. في 15+ لا يسمح بدخول من هم دون 15 سنة. وفي 18+ لا يسمح بدخول من هم دون 18 سنة. وفي 21+ لا يسمح بدخول من هم دون 21 سنة. في تصنيفات 15+ و18+ و21+ لا يسمح بدخول الرضع أو الأطفال الصغار، وتلزم الهوية وإثبات العمر. لا يمكن لمن هم دون السن المحدد دخول الأفلام المقيدة حتى برفقة ولي الأمر. ويعني 18TC أن شهادة التصنيف النهائية بانتظار الاعتماد وأن الفيلم يعامل مؤقتاً كتصنيف 18+؛ راع ذلك قبل الحجز لأن التذاكر غير قابلة للاسترداد. لفيلم محدد، استخدم شهادة التصنيف الظاهرة في بيانات الفيلم أو العرض الحالية.",
    }),
    delivery: STATIC,
    metadata: metadata({
      tags: { en: ["age", "rating", "certificate", "review score", "child", "id", "g", "pg", "pg13", "pg15", "15+", "18+", "21+", "18tc"], ar: ["عمر", "تصنيف", "شهادة", "درجة مراجعة", "طفل", "هوية", "قاصر", "G", "PG", "PG13", "PG15", "15+", "18+", "21+", "18TC"] },
      source: [VOX_OFFICIAL_SOURCES.faq],
