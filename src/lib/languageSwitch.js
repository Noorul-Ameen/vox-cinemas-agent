...
const DIRECT_ARABIC = [
  ...
  /^(تكلم|تحدث|كمل|اكمل|استمر|تابع)(?: باللغة العربية| بالعربية| بالعربي| عربي| العربية)$/,
...
const DIRECT_ENGLISH = [
  ...
  /^(تكلم|تحدث|كمل|اكمل|استمر|تابع)(?: باللغة الانجليزية| بالانجليزية| بالانجليزي| انجليزي| الانجليزية)$/,
