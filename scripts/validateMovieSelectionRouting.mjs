...
assert.match(app, /const resolvedMovieSelectionTurn = discoveryPreferencesRef\.current\.movieTitle \|\| pendingMovieSelectionTurn;[\s\S]*routePendingVisibleMovieLazy\(\{[\s\S]*text: resolvedMovieSelectionTurn/, "a resolved title-first discovery request must advance directly to verified showtimes");
